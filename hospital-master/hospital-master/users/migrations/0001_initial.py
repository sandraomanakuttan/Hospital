    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street_Line_1', models.CharField(max_length=25, null=True)),
                ('street_Line_2', models.CharField(max_length=25, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(max_length=30, null=True)),
                ('country', models.CharField(max_length=25, null=True)),
                ('department', models.CharField(choices=[('cardiology', 'Cardiology'), ('neurology', 'Neurology'), ('paediatrician', 'Paediatrician')], default='paediatrician', max_length=35)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
